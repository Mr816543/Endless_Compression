...
1.代码可读性,规范性优化
2.新增设置 压缩敌方基地
打开后敌方的全部建筑将变为和玩家核心等级一致的压缩建筑,仅在敌方核心不是压缩核心时生效(需要重新进入地图)
...
所有的压缩冲击钻头
4.进行本次更新后若遇到地图损坏
请尝试开启 屏蔽部分内容 设置后重启并进入损坏的地图
5.添加了更多bug待发现

v2.1.8
1.修复了压缩涡轮冷凝器产出水较少的问题
2.新增了建筑性能消耗统计的功能,
可在设置中开启 建筑性能消耗统计 来进行一次建筑性能消耗统计
统计完成后自动关闭
3.修复了压缩钻头在个别设备上的显著额外性能消耗

V2.1.7
1.暂时移除了自动检测更新的功能,请前往无尽压缩Mod交流群获取最新的更新情况
2.修复了部分设备进不去游戏的问题(对就是上面那个自动检测更新的问题)

v2.1.6
1.减少了压缩钻头系列的性能开销
2.修复了压缩热需求工厂不能从热量传输机获取热量的bug
3.新增了压缩载荷装载器,压缩载荷卸载器

v2.1.5
1.新增了压缩构筑器,压缩解钩器
2.新增了压缩融毁,压缩升华,压缩光辉
3.修复了压缩城堡核心不能直接覆盖上一级城堡核心建造的问题
4.修复了压缩子弹不会增强击退距离的问题

v2.1.4
1.添加自动检测更新功能,可在设置中选择是否进行自动检测更新
2.添加压缩强化流体带桥
3.压缩强化管道现在将使用对应的压缩强化流体带桥来跨越障碍物
4.增强了压缩钻头等挖矿设备的自动压缩速度
5.压缩雷达现在可以覆盖建造
6.新增了更多的bug

v2.1.2.1
1.压缩内容的研究和建造要求的数量将会根据压缩等级按比例降低
2.修复了部分压缩内容建造时不消耗材料的问题

v2.1.2
1.修复了部分成就无法正常解锁的问题
2.修复了百分比治疗压缩核心/城墙/单位时,治疗量异常低的问题
3.修复了压缩单位生命值不正常的问题
4.调整了压缩液泵重整成就的解锁条件,现在只需求解锁任一星球的全部压缩四重液泵
5.新增了压缩差扰

v2.1.1
1.修复了压缩液体储液罐因运输速度过快而导致的空罐问题
2.修复了压缩核心,压缩单位的血量上限溢出问题
3.调整了压缩炮台的索敌范围,现在压缩炮台的射程会根据弹药的压缩等级进行增幅
4.屏蔽部分内容设置的屏蔽内容修改为
所有的压缩液体炮台
5.进行本次更新后若遇到地图损坏
请尝试开启 屏蔽部分内容 设置后重启并进入损坏的地图
...
v2.1.0.3
1.修复了压缩墙壁粉碎机输出缓慢的bug
2.修复了压缩物品管道,压缩物品管道路由器等不能向原版物品管道,物品管道路由器等传输物品的bug
3.修复了压缩物品管道,压缩物品管道路由器等在已有物品时仍可能会接受其他物品的bug
4.新增了压缩物品管道溢流门,压缩物品管道装卸器
5.新增了压缩再生投影器,压缩建造塔,压缩震爆塔
6.新增了压缩单位物流装载器,压缩单位物流卸载点
7.新增了压缩单位维修塔

v2.1.0.2
1.修复了压缩器输出液体时过于缓慢的问题
2.修复了需要特定环境的压缩工厂可以放置在非特定环境的问题
3.修复了压缩等离子钻机,压缩冲击钻头,压缩墙壁粉碎机不能覆盖建造的问题
4.新增了压缩瘤液
5.新增了压缩雷达,压缩激光节点,压缩通量反应堆,压缩瘤变反应堆
6.修复了拆解者成就在战役中的进攻区块不能正常解锁的问题

v2.1.0.1
1.新增了压缩热工厂,压缩物品管道路由器,压缩墙壁粉碎机
2.新增了成就:
墙壁粉碎机重整

v2.1.0.0
1.新增了压缩等离子钻机,压缩冲击钻头,压缩物品管道
2.新增了成就:
等离子钻机重整
冲击钻头重整
3.修复了作者2026年未更新的bug
...
v2.0.9.7
1.修复了压缩波次提示的文本开头多了个数字1的问题
2.新增了成就:
拆解者:解锁奖励:击杀统计面板
更好的核心:解锁奖励:核心能够自动解压物品
3.修复了压缩传送带桥能透支物品的问题

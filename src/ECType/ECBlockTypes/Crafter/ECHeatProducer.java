...
public class ECHeatProducer extends ECMultiCrafter implements EC {

    public HeatProducer root;

    public ECHeatProducer(HeatProducer root) throws IllegalAccessException {
